...
```
based on our two sample T tests we can inter that the p-is 0.00000003405, from this we can reject the null hypothesis because of the sample result was very unlikely, meaning that the null hypoyhesis rejected.  
